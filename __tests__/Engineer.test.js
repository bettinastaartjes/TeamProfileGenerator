...
const employee = new Engineer ('Bettina', '123456', 'bettina@gmai.com', 'bettinastaartjes');
...
test('testing if we can get the constructor values for the employee object', () => {
    ...
    expect (employee.githubUsername).toBe('bettinastaartjes');
  });
  ...
  test('test if we can get the github number from officeNumber method', () => {
    expect(employee.getGithubUsername()).toBe('bettinastaartjes');
  });
